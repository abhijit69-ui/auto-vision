...
CREATE TABLE "public"."DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Autovision',
    "address" TEXT NOT NULL DEFAULT '69 Whip Street, Autoville, LA 69696',
    "phone" TEXT NOT NULL DEFAULT '+1 (251) 168-6782',
    "email" TEXT NOT NULL DEFAULT 'contact@autovision.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
